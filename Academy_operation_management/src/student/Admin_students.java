...
public class Admin_students extends JFrame implements MouseListener {
	...
	private String[] twoH = {"입실", "퇴실", "지각여부", "조퇴" ,"조퇴사유"};
	private String[] threeH = {"시험날짜", "시험이름", "국어", "영어" ,"수학", "보충학습"};
	private String[] fourH = {"교재명", "교재가격", "교재비수납여부"};
	...
	public Admin_students() {
		...
		button_1.setBounds(103, 245, 106, 23);
	...
	public JTabbedPane createTabbedPane() {
		...
		pannel4 = new JPanel();
		pannel4.setBackground(UIManager.getColor("InternalFrame.inactiveTitleGradient"));
		pannel4.setBorder(null);
		pannel4.setLayout(null);
		
		jtable1 = new JTable(one, oneH);
		jscp1 = new JScrollPane(jtable1);
		
		JTable jtable2 = new JTable(two, twoH);
		JScrollPane jscp2 = new JScrollPane(jtable2);
		jscp2.setBorder(null);
		jscp2.setBounds(0, 0, 630, 117);
		pannel2.add(jscp2);
		
		JTable jtable3 = new JTable(three, threeH);
		JScrollPane jscp3 = new JScrollPane(jtable3);
		jscp3.setBorder(null);
		jscp3.setBounds(0, 0, 630, 117);
		pannel3.add(jscp3);
		
		JTable jtable4 = new JTable(four, fourH);
		JScrollPane jscp4 = new JScrollPane(jtable4);
		jscp4.setBorder(null);
		jscp4.setBounds(0, 0, 630, 117);
		pannel4.add(jscp4);
		...
		Button button_4 = new Button("\uAC15\uC88C\uC218\uC815");
		button_4.setBounds(418, 129, 87, 23);
		pannel1.add(button_4);
		pane.addTab("출결", pannel2);
		
		Button button_2 = new Button("\uC870\uD1F4\uC0AC\uC720\uC791\uC131");
		button_2.setBounds(503, 129, 117, 23);
		pannel2.add(button_2);
		pane.addTab("성적", pannel3);
		
		Button button_1 = new Button("\uC810\uC218\uB4F1\uB85D");
		button_1.setBounds(533, 129, 87, 23);
		pannel3.add(button_1);
		pane.addTab("교재", pannel4);
		
		Button button = new Button("\uAD50\uC7AC\uCD94\uAC00");
		button.setBounds(533, 129, 87, 23);
		pannel4.add(button);
